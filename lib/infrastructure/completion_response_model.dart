...
class OpenAICompletionsResponse {
  ...
  OpenAICompletionsResponse.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    object = json['object'];
  ...
  static Future<OpenAICompletionsResponse?> parseInfo(String? string) async {
    try {
      return OpenAICompletionsResponse.fromJson(jsonDecode(string!));
    } catch (e) {
      return null;
    }
  }
